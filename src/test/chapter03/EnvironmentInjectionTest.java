...
import com.ascland.chapter03.externals.*;
...
public class EnvironmentInjectionTest {
    ...
    @RunWith(SpringJUnit4ClassRunner.class)
    @ContextConfiguration("classpath:chapter03/placeholder-config.xml")
    ...
    @RunWith(SpringJUnit4ClassRunner.class)
    @ContextConfiguration(classes = EnvironmentPropertiesAnnotationConfig.class)
    public static class InjectFromProperties_AnnotationConfig {
